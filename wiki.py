# In order to see the pre-trained trained models effectively, strings should be
# processed at runtime in exactly the same way as the training data were pre-processed.
...
# There is known issue with the original script, which unfortunately we must
# re-implement here, because that is how the models were trained.
#
# From https://github.com/facebookresearch/fastText/issues/281
#
# "Pre-trained models preproc script normalises away all digits, some quotes"
#
